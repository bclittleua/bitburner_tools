/** @param {NS} ns **/
// Found, and tbh I'm not sure what is happening here.
// Seems to determine how much of your profit is derived from a given server, 
// BUT as a sum of $ from hack scripts AND $ earned from hacking the server itself.
// i think. ¯\_(ツ)_/¯
// Despite the uncertainty, I still like to run this script occasionally.
