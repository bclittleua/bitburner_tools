//This script looks for servers that do not have ROOT access
...
ns.tprintf("Servers that still need root access: " + todo);
if (todo == 0){ns.tprint("WARN: Your BOSS level is off the charts!")}
