// Found. What follows are original author's comments.
...
let cycle = 0;
// ~~~~~~~You can edit these~~~~~~~~
const forecastThresh = 0.75; // Buy above this confidence level (forecast%) ← ← ← ← ← ← 
const minimumCash = 10000000000; // Minimum cash to keep ← ← ← ← ← ←
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
